...
uint8_t BT_LOCAL_NAME[] = {'T', 'P', 'U', 'T','_','C','L','I','E','N','T','\0' };
...
const wiced_bt_cfg_settings_t wiced_bt_cfg_settings =
{
    ...
    .ble_scan_cfg =                                                 /* BLE scan settings  */
    {
        ...
        .conn_min_interval               = 21,                                                        /**< Minimum connection interval */
        .conn_max_interval               = 21,                                                        /**< Maximum connection interval */
        .conn_latency                    = WICED_BT_CFG_DEFAULT_CONN_LATENCY,                         /**< Connection latency */
        .conn_supervision_timeout        = 2000,                                                      /**< Connection link supervision timeout */
    },
    ...
    .gatt_cfg =                                                     /* GATT configuration */
    {
        ...
        .max_attr_len                   = 244,                                                        /**< Maximum attribute length; gki_cfg must have a corresponding buffer pool that can hold this length */
        .max_mtu_size                   = 247                                                         /**< Maximum MTU size for GATT connections, should be between 23 and (max_attr_len + 5) */
    },
    ...
    .default_ble_power_level = 12                                                                         /**< Default LE power level, Refer lm_RxPwrTable table for the power range */
#endif
...
/*  { buf_size, buf_count } */
    ...
    { 360,      26 },       /* Medium Buffer Pool (used for HCI & RFCOMM control messages, min recommended size is 360) */
